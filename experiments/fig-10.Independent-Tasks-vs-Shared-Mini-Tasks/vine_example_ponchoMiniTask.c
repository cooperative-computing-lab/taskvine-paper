...
int main(int argc, char *argv[])
{
	...
	vine_set_runtime_info_path("vine_example_ponchoMINITASK_info");
	...
	for(i=0;i<1000;i++) {
		...
		struct vine_task *task = vine_task_create("poncho_package_run -e env python script.py");
		vine_task_add_input(task, poncho_env, "env", 0);
